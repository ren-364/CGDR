...
import numpy as np
from dnc import DNC
from layers_7 import GraphConvolution, DM_gcn
...
class CGMR(nn.Module):
    def __init__(self, voc, vocab_size, ehr_adj, diag2med, ddi_adj, emb_dim, device=torch.device('cpu:0'), ddi_in_memory=True, d_Hetertensor=None, p_Hetertensor=None):
