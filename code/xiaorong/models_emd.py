...
class GAMENet(nn.Module):
    def __init__(self, vocab_size, ehr_adj, diag2med, ddi_adj, emb_dim=64, device=torch.device('cpu:0'), ddi_in_memory=True, d_Hetertensor=None, p_Hetertensor=None):
    ...
    def forward(self, input):
        ...
        for adm in input:
            i1 = mean_embedding(diagEmd[adm[0]].unsqueeze(dim=0))
